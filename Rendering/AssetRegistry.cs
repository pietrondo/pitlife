...
public static class AssetRegistry
{
    ...
    private static readonly List<SpeciesAsset> SpeciesTextureEntries = new()
    {
        ...
        new("Dolphin", "Content/assets/creatures/fish/dolphin.png"),
        new("Whale", "Content/assets/creatures/fish/shark.png"),
        new("Manatee", "Content/assets/creatures/mammals/herbivores/manatee.png"),
        new("Orca", "Content/assets/creatures/fish/orca.png"),
        new("Seal", "Content/assets/creatures/mammals/carnivores/sealions/sealion.png"),
        new("SeaLion", "Content/assets/creatures/mammals/carnivores/sealions/sealion.png"),
        new("Otter", "Content/assets/creatures/mammals/omnivores/procyonids/raccoon.png"),
        new("Walrus", "Content/assets/creatures/mammals/omnivores/suids/walrus.png"),
        new("Hippopotamus", "Content/assets/creatures/mammals/omnivores/suids/hippo.png"),
        ...
        new("Pufferfish", "Content/assets/creatures/fish/tropical/pufferfish.png"),
        ...
        new("Ant", "Content/assets/creatures/invertebrates/insects/ant.png"),
        new("Bee", "Content/assets/creatures/invertebrates/insects/bee.png"),
        new("Wasp", "Content/assets/creatures/invertebrates/insects/wasp.png"),
        ...
        new("Mangrove", "Content/assets/plants/trees/oak_tree.png"),
        new("Reeds", "Content/assets/plants/grass/grass.png"),
        new("Lotus", "Content/assets/plants/aquatic/water_lily.png"),
        new("Willow", "Content/assets/plants/trees/oak_tree.png"),
        new("Thistle", "Content/assets/creatures/plants/flowers/lavender.png"),
        new("Vine", "Content/assets/creatures/plants/ferns/fern.png"),
        new("Rose", "Content/assets/creatures/plants/flowers/flowers.png"),
        new("Elephant", "Content/assets/creatures/mammals/herbivores/elephants/elephant.png"),
        new("Giraffe", "Content/assets/creatures/mammals/herbivores/giraffes/giraffe.png"),
        new("Zebra", "Content/assets/creatures/mammals/herbivores/zebras/zebra.png"),
        new("Bison", "Content/assets/creatures/mammals/herbivores/bison/bison.png"),
        new("Panda", "Content/assets/creatures/mammals/carnivores/felids/tiger.png"),
        new("Capybara", "Content/assets/creatures/mammals/omnivores/procyonids/raccoon.png"),
        new("Sloth", "Content/assets/creatures/mammals/omnivores/procyonids/raccoon.png"),
        new("Caterpillar", "Content/assets/creatures/invertebrates/insects/ant.png"),
        new("Snail", "Content/assets/creatures/invertebrates/insects/ant.png"),
        new("Parrot", "Content/assets/creatures/birds/owls/owl.png"),
        new("ManateeDugong", "Content/assets/creatures/fish/fish.png"),
        new("SeaTurtle", "Content/assets/creatures/fish/tropical/fish.png"),
        new("PolarBear", "Content/assets/creatures/mammals/carnivores/polarbears/polarbear.png"),
        new("KomodoDragon", "Content/assets/creatures/reptiles/komodo/komodo.png"),
        new("Hyena", "Content/assets/creatures/mammals/carnivores/hyenas/hyena.png"),
        new("Panther", "Content/assets/creatures/mammals/carnivores/panthers/panther.png"),
        new("Falcon", "Content/assets/creatures/birds/falcons/falcon.png"),
        new("Spider", "Content/assets/creatures/invertebrates/insects/ant.png"),
        new("Scorpion", "Content/assets/creatures/invertebrates/insects/ant.png"),
        new("AnglerFish", "Content/assets/creatures/fish/angler/angler.png"),
        new("Barracuda", "Content/assets/creatures/fish/piranha.png"),
        new("KillerWhale", "Content/assets/creatures/fish/shark.png"),
        new("Chimpanzee", "Content/assets/creatures/mammals/omnivores/chimpanzee/chimpanzee.png"),
        new("Squirrel", "Content/assets/creatures/mammals/omnivores/procyonids/raccoon.png"),
        new("Crow", "Content/assets/creatures/birds/crows/crow.png"),
        new("Hedgehog", "Content/assets/creatures/mammals/omnivores/hedgehog/hedgehog.png"),
        new("Duck", "Content/assets/creatures/birds/ducks/duck.png"),
        new("Octopus", "Content/assets/creatures/invertebrates/octopus/octopus.png"),
        new("Cockroach", "Content/assets/creatures/invertebrates/insects/beetle.png"),
        new("Earthworm", "Content/assets/creatures/invertebrates/insects/ant.png"),
