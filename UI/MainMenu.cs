...
public sealed class MainMenu
{
    ...
    private void Layout(int viewportWidth, int viewportHeight)
    {
        ...
        if (_showOptions)
        {
            LayoutOptionsPanel(viewportWidth, panelWidth, startY);
        }
        else
        {
            LayoutMainMenu(viewportWidth, panelWidth, startY);
        }
    }
    ...
    private void LayoutOptionsPanel(int viewportWidth, int panelWidth, int startY)
    {
    ...
    private void LayoutMainMenu(int viewportWidth, int panelWidth, int startY)
    {
        int buttonWidth = panelWidth - 48;
        int buttonHeight = 52;
        int gap = 12;
