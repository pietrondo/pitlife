...
public static class I18n
{
    ...
    private static Dictionary<string, string> CreateEnglishCatalog() => new(StringComparer.Ordinal)
    {
        ...
        ["toolbar.speed"] = "SPEED",
        ["toolbar.cataclysm"] = "CATACLYSM",
        ["toolbar.climate"] = "CLIMATE",
        ["toolbar.menu"] = "MENU",
        ["window.statistics"] = "STATISTICS",
        ["window.creature"] = "CREATURE DETAILS",
        ["window.terrain"] = "TERRAIN ANALYSIS",
        ["window.cataclysm"] = "CATACLYSMS",
        ["window.climate"] = "CLIMATE DASHBOARD",
        ["cata.asteroid"] = "Asteroid",
        ["cata.iceage"] = "Ice Age",
        ["cata.supervolcano"] = "Supervolcano",
        ["cata.earthquake"] = "Earthquake",
        ["cata.drought"] = "Drought",
        ["cata.flood"] = "Flood",
        ["cata.placeHint"] = "Click map to place",
        ...
        ["terrain.elevation"] = "Elevation: {0:F0} m",
        ...
        ["climate.season"] = "Season: {0}",
        ["climate.temperature"] = "Temperature: {0}",
        ["climate.orbit"] = "Sun {0:F3} AU | {1:F0}° | {2:F1} km/s",
        ["climate.wind"] = "Wind: {0:F1} m/s @ {1:F0}°",
        ["climate.extreme"] = "!! {0} !!",
        ["climate.populations"] = "Populations",
        ["climate.events"] = "Recent Events",
        ["evt.season"] = "[STAGIONE]",
        ["evt.cataclysm"] = "[CATACLISMA]",
        ["evt.climate"] = "[CLIMA]",
        ["evt.death"] = "[MORTE]",
        ["evt.spawn"] = "[SPAWN]",
        ["evt.terrain"] = "[TERRENO]",
        ["evt.msg.season"] = "Stagione:",
        ["evt.msg.at"] = "a T",
        ["evt.msg.player"] = "Giocatore",
        ["evt.msg.extinction"] = "ESTINZIONE:",
        ["evt.msg.extreme"] = "Evento estremo",
        ["evt.msg.started"] = "iniziato",
        ["evt.msg.ended"] = "finito",
        ["evt.msg.spawned"] = "Spawnati",
        ["evt.msg.crater"] = "cratere a",
        ["evt.msg.radius"] = "r",
        ["evt.msg.duration"] = "durata",
        ["evt.msg.cataend"] = "Cataclisma terminato",
        ["evt.msg.died"] = "morto a",
        ["evt.msg.dist"] = "dist",
        ["climate.local"] = "({0},{1}) {2}  {3}°C",
        ["climate.localseason"] = "Local: {0}",
        ...
        ["menu.worldGenTitle"] = "WORLD GENERATION",
        ["menu.worldGenHint"] = "ESC: back",
        ["menu.preset"] = "Preset",
        ["menu.continents"] = "Continents",
        ["menu.seaLevel"] = "Sea Level %",
        ["menu.islandSize"] = "Island Size",
        ["menu.mapSize"] = "Map Size",
        ["menu.planet"] = "Planet",
    ...
    private static Dictionary<string, string> CreateItalianCatalog()
    {
        var catalog = new Dictionary<string, string>(English, StringComparer.Ordinal)
        {
            ...
            ["toolbar.speed"] = "VELOCITA",
            ["toolbar.cataclysm"] = "CATACLISMI",
            ["toolbar.climate"] = "CLIMA",
            ["toolbar.menu"] = "MENU",
            ["window.statistics"] = "STATISTICHE",
            ["window.creature"] = "DETTAGLI CREATURA",
            ["window.terrain"] = "ANALISI TERRENO",
            ["window.cataclysm"] = "CATACLISMI",
            ["window.climate"] = "DASHBOARD CLIMA",
            ["cata.asteroid"] = "Asteroide",
            ["cata.iceage"] = "Era Glaciale",
            ["cata.supervolcano"] = "Supervulcano",
            ["cata.earthquake"] = "Terremoto",
            ["cata.drought"] = "Siccità",
            ["cata.flood"] = "Inondazione",
            ["cata.placeHint"] = "Clicca la mappa per piazzare",
            ...
            ["terrain.elevation"] = "Elevazione: {0:F0} m",
        ...
        ["spawn.aquaticplants"] = "Piante Acquatiche",
            ...
            ["climate.season"] = "Stagione: {0}",
            ["climate.temperature"] = "Temperatura: {0}",
            ["climate.orbit"] = "Sole {0:F3} UA | {1:F0}° | {2:F1} km/s",
            ["climate.wind"] = "Vento: {0:F1} m/s @ {1:F0}°",
            ["climate.extreme"] = "!! {0} !!",
            ["climate.populations"] = "Popolazioni",
            ["climate.events"] = "Eventi Recenti",
        ["evt.season"] = "[SEASON]",
        ["evt.cataclysm"] = "[CATACLYSM]",
        ["evt.climate"] = "[CLIMATE]",
        ["evt.death"] = "[DEATH]",
        ["evt.spawn"] = "[SPAWN]",
        ["evt.terrain"] = "[TERRAIN]",
        ["evt.msg.season"] = "Season:",
        ["evt.msg.at"] = "at T",
        ["evt.msg.player"] = "Player",
        ["evt.msg.extinction"] = "EXTINCTION:",
        ["evt.msg.extreme"] = "Extreme event",
        ["evt.msg.started"] = "started",
        ["evt.msg.ended"] = "ended",
        ["evt.msg.spawned"] = "Spawned",
        ["evt.msg.crater"] = "crater at",
        ["evt.msg.radius"] = "r",
        ["evt.msg.duration"] = "duration",
        ["evt.msg.cataend"] = "Cataclysm ended",
        ["evt.msg.died"] = "died at",
        ["evt.msg.dist"] = "dist",
        ["climate.local"] = "({0},{1}) {2}  {3}°C",
            ["climate.localseason"] = "Locale: {0}",
            ...
            ["menu.generate"] = "GENERA",
            ["menu.worldGenTitle"] = "GENERAZIONE MONDO",
            ["menu.worldGenHint"] = "ESC: indietro",
            ["menu.preset"] = "Preset",
            ["menu.continents"] = "Continenti",
            ["menu.seaLevel"] = "Livello Mare %",
            ["menu.islandSize"] = "Dimensione Isole",
            ["menu.mapSize"] = "Dimensione Mappa",
            ["menu.planet"] = "Pianeta",
